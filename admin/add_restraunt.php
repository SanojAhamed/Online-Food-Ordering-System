...
<head>
    ...
    <title>Deli - add restraunt</title>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" class="form-control" placeholder="Hotel Sanasta">
                                                   </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" placeholder="055-111-1111">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
