...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/main12.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Food that will make you happy</h1>
                <h5 class="font-white space-xs">Delivering classic comforting dishes that always hit the right spot!</h5>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We got you covered with more than 20+ popular delivery restaurants.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <p>We are serving you more than 100+ popular dish varieties.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row top-footer">
                <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                    <a href="#"> <img src="images/DELI-LOGO12.png" alt="Footer logo"> </a> <span>Choose it &amp; Enjoy your meals! </span>
                </div>
